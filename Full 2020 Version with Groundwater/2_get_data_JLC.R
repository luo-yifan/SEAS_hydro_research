...
###### Hong DO: Oct 27 2019 - do not fill in missing value 
...
clairBOM = read.csv('input/STC_BOM_MM.csv', TRUE, skip=6);
clairDS = cbind(
...
clairNBS = read.csv('input/STC_lake_NBS.csv', TRUE, na.strings='-9999.9', skip=4);
...
clairOutflow = read.csv('input/DetroitMonthlyMeanFlows.csv', TRUE, skip=8);
...
clairPrecip = read.csv('input/STC_lake_Prec.csv', TRUE, na.strings='-9999.9', skip=4);
...
clairEvap = read.csv('input/STC_lake_Evap.csv', TRUE, na.strings='-9999.9', skip=4);
...
clairRunoff = read.csv('input/STC_lake_Runoff.csv', TRUE, na.strings='None', skip=4);
...
erieDiversion = read.csv('input/WellandMonthlyMeanFlows.csv', TRUE, skip=6);
...
ontarioBOM = read.csv('input/ONT_BOM_MM.csv', TRUE, skip=6);
ontarioDS = cbind(
	ontarioBOM[-(nrow(ontarioBOM)),1:2],
	(ontarioBOM[-1,3] - ontarioBOM[-(nrow(ontarioBOM)),3])*1000
);

ontarioOutflow = read.csv('input/StLawrenceMonthlyMeanFlows.csv', TRUE, skip=7);
...
ontarioPrecip = read.csv('input/ONT_lake_Prec.csv', TRUE, na.strings='-9999.9', skip=4);
...
ontarioEvap = read.csv('input/ONT_lake_Evap.csv', TRUE, na.strings='-9999.9', skip=4);
...
ontarioRunoff = read.csv('input/ONT_lake_Runoff.csv', TRUE, na.strings='None', skip=4);
...
ontarioNBS = read.csv('input/ONT_lake_NBS.csv', TRUE, na.strings='-9999.9', skip=4);
...
lakesGroundwater = read.csv('input/Aquanty_GroundwaterMonthlyDischarge.csv', TRUE)
superiorGroundwater = lakesGroundwater$SUP
miHuronGroundwater = lakesGroundwater$MHU
claireGroundwater = rep(0,12)
erieGroundwater = lakesGroundwater$ERI
ontarioGroundwater = lakesGroundwater$ONT
