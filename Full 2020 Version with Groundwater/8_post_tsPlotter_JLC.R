...
for(startMo in seq(posteriorStartMonth, posteriorEndMonth, 120)){
  ...
  smhGroundwaterLimits = c(-150,250)
  smhGroundwaterLimitsLabs = seq(-150,250,by=50)
  smhGroundwaterLimitsTicks = seq(-100,100,by=50)
  ceoGroundwaterLimits = c(-40,60)
  ceoGroundwaterLimitsLabs = seq(-40,60,by=20)
  ceoGroundwaterLimitsTicks = seq(-40,60,by=20)
  ...
  pdf(paste('superiorTS_ALL_d',decade,'_',modelName,'.pdf', sep=''), width = 10, height = 10);
  ...
  plot(c(0), c(0), type = "n", col = "darkgreen", lwd = 4, axes = FALSE, ylim = smhGroundwaterLimits, xlim = c(startMo,endMoPlot)); 
  box()
  abline(h=0, col = 8)
  axis(2, at=smhGroundwaterLimitsLabs, cex.lab = 0.7); 
  axis(2, at=smhGroundwaterLimitsTicks, labels=FALSE, cex.lab = 0.7); 
  axis(4, at=smhGroundwaterLimitsTicks, labels=FALSE, cex.lab = 0.7); 
  # axis(1, at=seq(startMo,endMoPlot,12), labels=FALSE);
  axis(1, at=seq(startMo,endMoPlot,6), labels=FALSE, las=2); # LMF 2019-06-18 fix for x-axis
  mtext('G (cms)', side = 2, line = 2.5, cex = 0.8)
  
  for(i in startMo:endMo){
    segments(   
      x0 = i+(1/2), x1 = i+(1/2), lwd = 4, col = 'gray60', lend = 2,
      y0 = jSum[paste('superiorGroundwater[',i,']', sep=''),3],
      y1 = jSum[paste('superiorGroundwater[',i,']', sep=''),7]
    );
    #lines(i+(1/2), jSum[paste('superiorGroundwater[',i,']', sep=''),5], col = "black",   lwd = 1, type='p', pch=15, cex=0.75)
    
    for(n in 3:ncol(superiorGroundwater_A)){
      lines(c(i, i+1), c(superiorGroundwater_A[i,n],superiorGroundwater_A[i,n]), col = colorVector[n-2],  lwd=1.5, type='s')
    }
  }    
  
  superiorGroundwaterLegend = c('L2SWBM', 'Aquanty');
  superiorGroundwaterLegendColors = c('gray60', colorVector[1]);
  
  legend(
    x = 'topleft',
    legend = superiorGroundwaterLegend,
    col = superiorGroundwaterLegendColors,
    bty = 'n',
    lty = c(0, rep(1, 2)),
    lwd = c(0, rep(1.5, 2)),
    pch = c(15, rep(NA, 2)),
  ...
  pdf(paste('miHuronTS_ALL_d',decade,'_',modelName,'.pdf', sep=''), width = 10, height = 10);
  ...
  plot(c(0), c(0), type = "n", axes = FALSE, xlim = c(startMo,endMoPlot), ylim = smhGroundwaterLimits); 
  box()
  axis(4, at=smhGroundwaterLimitsLabs, cex.lab = 0.7); 
  axis(4, at=smhGroundwaterLimitsTicks, labels=FALSE, cex.lab = 0.7); 
  axis(2, at=smhGroundwaterLimitsTicks, labels=FALSE, cex.lab = 0.7);  
  mtext(paste("G (cms)"), side = 2, line = 2.5, cex=0.8); 
  # axis(1, at=seq(startMo,endMoPlot,12), labels=FALSE);
  axis(1, at=seq(startMo,endMoPlot,6), labels=FALSE, las=2); # LMF 2019-06-18 fix for x-axis
  ...
  for(i in startMo:endMo){
    segments(   
      x0 = i+(1/2), x1 = i+(1/2), lwd = 4, col = 'gray60', lend = 2,
      y0 = jSum[paste('miHuronGroundwater[',i,']', sep=''),3],
      y1 = jSum[paste('miHuronGroundwater[',i,']', sep=''),7]
    );
    #lines(i+(1/2), jSum[paste('miHuronGroundwater[',i,']', sep=''),5], col = "black",   lwd = 1, type='p', pch=15, cex=0.75)
    
    
    for(n in 3:ncol(miHuronGroundwater_A)){
      lines(c(i, i+1), c(miHuronGroundwater_A[i,n],miHuronGroundwater_A[i,n]), col = colorVector[n-2],  lwd=1.5, type='s')
    }
  }      
  
  miHuronGroundwaterLegend = c('L2SWBM', 'Aquanty');
  miHuronGroundwaterLegendColors = c('gray60', colorVector[1]);
  
  legend(
    x = 'topleft',
    legend = miHuronGroundwaterLegend,
    col = miHuronGroundwaterLegendColors,
    bty = 'n',
    lty = c(0, rep(1, 2)),
    lwd = c(0, rep(1.5, 2)),
    pch = c(15, rep(NA, 2)),
  ...
  pdf(paste('clair_ALL_d',decade,'_',modelName,'.pdf', sep=''), width = 10, height = 10);
  ...
  plot(c(0), c(0), type = "n", axes = FALSE, xlim = c(startMo,endMoPlot), ylim = ceoGroundwaterLimits); 
  box()
  axis(4, at=ceoGroundwaterLimitsLabs, cex.lab = 0.7); 
  axis(4, at=ceoGroundwaterLimitsTicks, labels=FALSE, cex.lab = 0.7); 
  axis(2, at=ceoGroundwaterLimitsTicks, labels=FALSE, cex.lab = 0.7);  
  mtext(paste("G (cms)"), side = 2, line = 2.5, cex=0.8); 
  # axis(1, at=seq(startMo,endMoPlot,12), labels=FALSE);
  axis(1, at=seq(startMo,endMoPlot,6), labels=FALSE, las=2); # LMF 2019-06-18 fix for x-axis
  ...
  for(i in startMo:endMo){
    segments(   
      x0 = i+(1/2), x1 = i+(1/2), lwd = 4, col = 'gray60', lend = 2,
      y0 = jSum[paste('clairGroundwater[',i,']', sep=''),3],
      y1 = jSum[paste('clairGroundwater[',i,']', sep=''),7]
    );
    #lines(i+(1/2), jSum[paste('clairGroundwater[',i,']', sep=''),5], col = "black",   lwd = 1, type='p', pch=15, cex=0.75)
    
    
    for(n in 3:ncol(clairGroundwater_A)){
      lines(c(i, i+1), c(clairGroundwater_A[i,n],clairGroundwater_A[i,n]), col = colorVector[n-2],  lwd=1.5, type='s')
    }
  }     
  
  clairGroundwaterLegend = c('L2SWBM', 'Aquanty');
  clairGroundwaterLegendColors = c('gray60', colorVector[1]);
  
  legend(
    x = 'topleft',
    legend = clairGroundwaterLegend,
    col = clairGroundwaterLegendColors,
    bty = 'n',
    lty = c(0, rep(1, 2)),
    lwd = c(0, rep(1.5, 2)),
    pch = c(15, rep(NA, 2)),
  ...
  pdf(paste('erieTS_ALL_d',decade,'_',modelName,'.pdf', sep=''), width = 10, height = 10);
  if(erieComponentWBM){
    par(mfrow=c(7,1))
  }else{
    par(mfrow=c(5,1))
  ...
  for(i in startMo:endMo){
    segments(   
      x0 = i+(1/2), x1 = i+(1/2), lwd = 4, col = 'gray60', lend = 2,
      y0 = jSum[paste('erieGroundwater[',i,']', sep=''),3],
      y1 = jSum[paste('erieGroundwater[',i,']', sep=''),7]
    );
    #lines(i+(1/2), jSum[paste('erieGroundwater[',i,']', sep=''),5], col = "black",   lwd = 1, type='p', pch=15, cex=0.75)
    
    
    for(n in 3:ncol(erieGroundwater_A)){
      lines(c(i, i+1), c(erieGroundwater_A[i,n],erieGroundwater_A[i,n]), col = colorVector[n-2],  lwd=1.5, type='s')
    }
  }     
  
  erieGroundwaterLegend = c('L2SWBM', 'Aquanty');
  erieGroundwaterLegendColors = c('gray60', colorVector[1]);
  
  legend(
    x = 'topleft',
    legend = erieGroundwaterLegend,
    col = erieGroundwaterLegendColors,
    bty = 'n',
    lty = c(0, rep(1, 2)),
    lwd = c(0, rep(1.5, 2)),
    pch = c(15, rep(NA, 2)),
  ...
  pdf(paste('ontarioTS_ALL_d',decade,'_',modelName,'.pdf', sep=''), width = 10, height = 10);
  ...
  for(i in startMo:endMo){
    segments(   
      x0 = i+(1/2), x1 = i+(1/2), lwd = 4, col = 'gray60', lend = 2,
      y0 = jSum[paste('ontarioGroundwater[',i,']', sep=''),3],
      y1 = jSum[paste('ontarioGroundwater[',i,']', sep=''),7]
    );
    #lines(i+(1/2), jSum[paste('ontarioGroundwater[',i,']', sep=''),5], col = "black",   lwd = 1, type='p', pch=15, cex=0.75)
    
    
    for(n in 3:ncol(ontarioGroundwater_A)){
      lines(c(i, i+1), c(ontarioGroundwater_A[i,n],ontarioGroundwater_A[i,n]), col = colorVector[n-2],  lwd=1.5, type='s')
    }
  }        
  
  ontarioGroundwaterLegend = c('L2SWBM', 'Aquanty');
  ontarioGroundwaterLegendColors = c('gray60', colorVector[1]);
  
  legend(
    x = 'topleft',
    legend = ontarioGroundwaterLegend,
    col = ontarioGroundwaterLegendColors,
    bty = 'n',
    lty = c(0, rep(1, 2)),
    lwd = c(0, rep(1.5, 2)),
    pch = c(15, rep(NA, 2)),
