...
# if(ncol(superiorGroundwater_A) >= 3){
#   for(i in 3:ncol(superiorGroundwater_A)){
#     yGroundwater[[paste('ySuperiorGroundwater',i-2,sep='')]] = superiorGroundwater_A[,i]
#     yGroundwaterBiasMean[[paste('ySuperiorGroundwater',i-2,'BiasMean',sep='')]] = gObsPriorMeanBias[i-2]
#     yGroundwaterBiasPrec[[paste('ySuperiorGroundwater',i-2,'BiasPrec',sep='')]] = 1/(gObsPriorBiasDev[i-2])^2
#     yGroundwaterPrec[[paste('ySuperiorGroundwater',i-2,'Prec',sep='')]] = 1/(gObsSD[i-2])^2
#   }
# }
# if(ncol(miHuronGroundwater_A) >= 3){
#   for(i in 3:ncol(miHuronGroundwater_A)){
#     yGroundwater[[paste('yMiHuronGroundwater',i-2,sep='')]] = miHuronGroundwater_A[,i]
#     yGroundwaterBiasMean[[paste('yMiHuronGroundwater',i-2,'BiasMean',sep='')]] = gObsPriorMeanBias[i-2]
#     yGroundwaterBiasPrec[[paste('yMiHuronGroundwater',i-2,'BiasPrec',sep='')]] = 1/(gObsPriorBiasDev[i-2])^2
#     yGroundwaterPrec[[paste('yMiHuronGroundwater',i-2,'Prec',sep='')]] = 1/(gObsSD[i-2])^2
#   }
# }
# if(ncol(erieGroundwater_A) >= 3){
#   for(i in 3:ncol(erieGroundwater_A)){
#     yGroundwater[[paste('yErieGroundwater',i-2,sep='')]] = erieGroundwater_A[,i]
#     yGroundwaterBiasMean[[paste('yErieGroundwater',i-2,'BiasMean',sep='')]] = gObsPriorMeanBias[i-2]
#     yGroundwaterBiasPrec[[paste('yErieGroundwater',i-2,'BiasPrec',sep='')]] = 1/(gObsPriorBiasDev[i-2])^2
#     yGroundwaterPrec[[paste('yErieGroundwater',i-2,'Prec',sep='')]] = 1/(gObsSD[i-2])^2
#   }
# }
# if(ncol(ontarioGroundwater_A) >= 3){
#   for(i in 3:ncol(ontarioGroundwater_A)){
#     yOutflow[[paste('yOntarioGroundwater',i-2,sep='')]] = ontarioGroundwater_A[,i]
#     yOutflowBiasMean[[paste('yOntarioGroundwater',i-2,'BiasMean',sep='')]] = gObsPriorMeanBias[i-2]
#     yOutflowBiasPrec[[paste('yOntarioGroundwater',i-2,'BiasPrec',sep='')]] = 1/(gObsPriorBiasDev[i-2])^2
#     yOutflowPrec[[paste('yOntarioGroundwater',i-2,'Prec',sep='')]] = 1/(gObsSD[i-2])^2
#   }
# }
...
superiorComponentNBS = list(
	...
	"superiorGroundwaterPriorMean"          = superiorGroundwaterPriorMean, #--JLC            
	"superiorGroundwaterPriorPrecision"     = superiorGroundwaterPriorPrecision,  #--JLC     
...
miHuronComponentNBS = list(
	...
	"miHuronGroundwaterPriorMean"          = miHuronGroundwaterPriorMean, #--JLC            
	"miHuronGroundwaterPriorPrecision"     = miHuronGroundwaterPriorPrecision,  #--JLC    
...
clairComponentNBS = list(
	...
	"clairGroundwaterPriorMean"          = clairGroundwaterPriorMean, #--JLC            
	"clairGroundwaterPriorPrecision"     = clairGroundwaterPriorPrecision  #--JLC 
);
...
erieComponentNBS = list(
	...
	"erieGroundwaterPriorMean"          = erieGroundwaterPriorMean, #--JLC            
	"erieGroundwaterPriorPrecision"     = erieGroundwaterPriorPrecision,  #--JLC       
...
ontarioComponentNBS = list(
	...
	"ontarioGroundwaterPriorMean"          = ontarioGroundwaterPriorMean, #--JLC            
	"ontarioGroundwaterPriorPrecision"     = ontarioGroundwaterPriorPrecision  #--JLC 
);
...
modelCode = paste(modelCode, '
		...
		superiorGroundwater[j] ~ dnorm(superiorGroundwaterPriorMean[m[j]], superiorGroundwaterPriorPrecision[m[j]]) #--JLC
...
modelCode = paste(modelCode, '
		...
		miHuronGroundwater[j] ~ dnorm(miHuronGroundwaterPriorMean[m[j]], miHuronGroundwaterPriorPrecision[m[j]]) #--JLC
...
modelCode = paste(modelCode, '
		...
		clairGroundwater[j] ~ dnorm(clairGroundwaterPriorMean[m[j]], clairGroundwaterPriorPrecision[m[j]]) #--JLC
...
modelCode = paste(modelCode, '
		...
		erieGroundwater[j] ~ dnorm(erieGroundwaterPriorMean[m[j]], erieGroundwaterPriorPrecision[m[j]]) #--JLC
...
modelCode = paste(modelCode, '
		...
		ontarioGroundwater[j] ~ dnorm(ontarioGroundwaterPriorMean[m[j]], ontarioGroundwaterPriorPrecision[m[j]]) #--JLC
...
'
		...
		superiorGroundwater_mm[k] <- sum(superiorGroundwater[(k-rollPeriod+1):k]/supArea*1000*secondsInADay*dayVector[(k-rollPeriod+1):k]) #--JLC
...
'
		...
		miHuronGroundwater_mm[k] <- sum(miHuronGroundwater[(k-rollPeriod+1):k]/mhgArea*1000*secondsInADay*dayVector[(k-rollPeriod+1):k]) #--JLC
...
'
		...
		# clairGroundwater_mm[k] <- sum(clairGroundwater[(k-rollPeriod+1):k]/stcArea*1000*secondsInADay*dayVector[(k-rollPeriod+1):k]) #--JLC		
',
sep=''	
);
}else{
...
'
		...
		erieGroundwater_mm[k] <- sum(erieGroundwater[(k-rollPeriod+1):k]/eriArea*1000*secondsInADay*dayVector[(k-rollPeriod+1):k]) #--JLC
...
'
		...
		ontarioGroundwater_mm[k] <- sum(ontarioGroundwater[(k-rollPeriod+1):k]/ontArea*1000*secondsInADay*dayVector[(k-rollPeriod+1):k]) #--JLC
...
if(clairCMS){
	...
	# 	',
	  '
		##############################
		## PRECISION FOR OBSERVATIONS --JLC
		##############################
		ySuperiorRStorePrec	  ~ dlnorm(-log(100)-log(rollPeriod),1)	
		yMiHuronRStorePrec	  ~ dlnorm(-log(100)-log(rollPeriod),1)
		yClairRStorePrec   ~ dlnorm(-log(100)-log(rollPeriod),1)
		yErieRStorePrec	  ~ dlnorm(-log(100)-log(rollPeriod),1)  
		yOntarioRStorePrec ~ dlnorm(-log(100)-log(rollPeriod),1)    
...
if(length(names(yOutflow)) > 0){
	for(n in 1:length(names(yOutflow))){
		...
		if(is.infinite(yOutflowPrec[[precLabel]])){
			modelCode = paste(
				modelCode,
				'\t',names(yOutflow)[n],'Prec ~ dlnorm(-log(100),1)\n',#'Prec ~ dgamma(0.1,0.1)\n',--JLC
				sep=''
			);
		}
		else{
...
if(length(names(yDiversion)) > 0){
	for(n in 1:length(names(yDiversion))){
		...
		if(is.infinite(yDiversionPrec[[precLabel]])){
			modelCode = paste(
				modelCode,
				'\t',names(yDiversion)[n],'Prec ~ dlnorm(-log(100),1)\n',#'Prec ~ dgamma(0.1,0.1)\n',--JLC
				sep=''
			);
		}
		else{
...
if(length(names(yPrecip)) > 0){
	for(n in 1:length(names(yPrecip))){
		...
		if(is.infinite(yPrecipPrec[[precLabel]])){
			modelCode = paste(
				modelCode,
				'\t',names(yPrecip)[n],'Prec ~ dlnorm(-log(100),1)\n',#'Prec ~ dgamma(0.1,0.1)\n',--JLC
				sep=''
			);
		}
		else{
...
if(length(names(yEvap)) > 0){
	for(n in 1:length(names(yEvap))){
		...
		if(is.infinite(yEvapPrec[[precLabel]])){
			modelCode = paste(
				modelCode,
				'\t',names(yEvap)[n],'Prec ~ dlnorm(-log(100),1)\n',#'Prec ~ dgamma(0.1,0.1)\n',--JLC
				sep=''
			);
		}
		else{
...
if(length(names(yRunoff)) > 0){
	for(n in 1:length(names(yRunoff))){
		...
		if(is.infinite(yRunoffPrec[[precLabel]])){
			modelCode = paste(
				modelCode,
				'\t',names(yRunoff)[n],'Prec ~ dlnorm(-log(100),1)\n',#'Prec ~ dgamma(0.1,0.1)\n',--JLC
				sep=''
			);
		}
		else{
...
if(length(names(yNBS)) > 0){
	for(n in 1:length(names(yNBS))){
		...
		if(is.infinite(yNBSPrec[[precLabel]])){
			modelCode = paste(
				modelCode,
				'\t',names(yNBS)[n],'Prec ~ dlnorm(-log(100),1)\n',#'Prec ~ dgamma(0.1,0.1)\n',--JLC
				sep=''
			);
		}
		else{
...
'
		...
		superiorDStore[jp] <- (
			...
			+superiorGroundwaterPP_mm[jp] #--JLC
		...
		superiorGroundwaterPP_mm[jp] <- superiorGroundwater[jp]/supArea*1000*secondsInADay*dayVector[jp] #--JLC
...
'
		...
		miHuronDStore[jp] <- (
			...
			+miHuronGroundwaterPP_mm[jp] #--JLC
		...
		miHuronGroundwaterPP_mm[jp] <- miHuronGroundwater[jp]/mhgArea*1000*secondsInADay*dayVector[jp] #--JLC
...
'
		...
		clairGroundwaterPP_mm[jp] <- clairGroundwater[jp]/stcArea*1000*secondsInADay*dayVector[jp] #--JLC
',
sep=''
);
}else{
...
'
		...
		erieGroundwaterPP_mm[jp] <- erieGroundwater[jp]/eriArea*1000*secondsInADay*dayVector[jp] #--JLC
...
'
		...
		ontarioDStore[jp] <- (
			...
			+ontarioGroundwaterPP_mm[jp] #--JLC
		...
		ontarioGroundwaterPP_mm[jp] <- ontarioGroundwater[jp]/ontArea*1000*secondsInADay*dayVector[jp] #--JLC
',
sep=''
);
}else{
...
'
		...
		superiorR1YStore[x] <- (
			...
			+superiorGroundwaterPPR1_mm[x] #--JLC
		...
		superiorGroundwaterPPR1_mm[x] <- sum(superiorGroundwater[(x-12+1):x]/supArea*1000*secondsInADay*dayVector[(x-12+1):x]) #--JLC
...
'
		...
		miHuronR1YStore[x] <- (
			...
			+miHuronGroundwaterPPR1_mm[x] #--JLC
		...
		miHuronGroundwaterPPR1_mm[x] <- sum(miHuronGroundwater[(x-12+1):x]/mhgArea*1000*secondsInADay*dayVector[(x-12+1):x]) #--JLC
...
'
		...
		clairGroundwaterPPR1_mm[x] <- sum(clairGroundwater[(x-12+1):x]/stcArea*1000*secondsInADay*dayVector[(x-12+1):x]) #--JLC
...
'
		...
		erieGroundwaterPPR1_mm[x] <- sum(erieGroundwater[(x-12+1):x]/eriArea*1000*secondsInADay*dayVector[(x-12+1):x]) #--JLC
...
'
		...
		ontarioR1YStore[x] <- (
			...
			+ontarioGroundwaterPPR1_mm[x] #--JLC
		...
		ontarioGroundwaterPPR1_mm[x] <- sum(ontarioGroundwater[(x-12+1):x]/ontArea*1000*secondsInADay*dayVector[(x-12+1):x]) #--JLC
',
sep=''
)
}else{
...
'
		...
		superiorR5YStore[z] <- (
			...
			+superiorGroundwaterPPR5_mm[z] #--JLC
		...
		superiorGroundwaterPPR5_mm[z] <- sum(superiorGroundwater[(z-60+1):z]/supArea*1000*secondsInADay*dayVector[(z-60+1):z]) #--JLC
...
'
		...
		miHuronR5YStore[z] <- (
			...
			+miHuronGroundwaterPPR5_mm[z] #--JLC
		...
		miHuronGroundwaterPPR5_mm[z] <- sum(miHuronGroundwater[(z-60+1):z]/mhgArea*1000*secondsInADay*dayVector[(z-60+1):z]) #--JLC
...
'
		...
		clairGroundwaterPPR5_mm[z] <- sum(clairGroundwater[(z-60+1):z]/stcArea*1000*secondsInADay*dayVector[(z-60+1):z]) #--JLC
...
'
		...
		erieGroundwaterPPR5_mm[z] <- sum(erieGroundwater[(z-60+1):z]/eriArea*1000*secondsInADay*dayVector[(z-60+1):z]) #--JLC
...
'
		...
		ontarioR5YStore[z] <- (
			...
			+ontarioGroundwaterPPR5_mm[z] #--JLC
		...
		ontarioGroundwaterPPR5_mm[z] <- sum(ontarioGroundwater[(z-60+1):z]/ontArea*1000*secondsInADay*dayVector[(z-60+1):z])
',
sep=''
);
}else{
...
paramsToMonitor <- c( 
	...
	"superiorGroundwater","superiorGroundwater_mm", #--JLC
	"miHuronGroundwater","miHuronGroundwater_mm", #--JLC
	# "clairGroundwater","clairGroundwater_mm", #--JLC
	"erieGroundwater","erieGroundwater_mm", #--JLC
	"ontarioGroundwater","ontarioGroundwater_mm" #--JLC
);
