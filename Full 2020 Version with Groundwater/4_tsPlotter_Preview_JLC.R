...
superiorGroundwater_A = data.frame(superiorOutflow_A[,1:2],Monthly.Mean=superiorGroundwater[superiorOutflow_A$Month]) #--JLC
...
miHuronGroundwater_A = data.frame(miHuronOutflow_A[,1:2],Monthly.Mean=miHuronGroundwater[miHuronOutflow_A$Month]) #--JLC
...
clairGroundwater_A = data.frame(clairOutflow_A[,1:2],Monthly.Mean=0) #--JLC
...
erieGroundwater_A = data.frame(erieOutflow_A[,1:2],Monthly.Mean=erieGroundwater[erieOutflow_A$Month]) #--JLC
...
ontarioGroundwater_A = data.frame(ontarioOutflow_A[,1:2],Monthly.Mean=ontarioGroundwater[ontarioOutflow_A$Month]) #--JLC
...
groundwaterLimits = c(-100,100)
groundwaterLimitsLabs = seq(-100,100,by=25)
groundwaterLimitsTicks = seq(-100,100,by=25)
...
pdf(paste('superiorTS_Preview_d',decade,'_',modelName,'.pdf', sep=''), width = 10, height = 10);
par(mfrow=c(7,1))
par(mar = c(0,0,0,0))
par(oma = c(4,4,4,4))
