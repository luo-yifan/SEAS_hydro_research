...
# superiorGroundwater_A = getSubset(superiorGroundwater, startAnalysisYear, startAnalysisMonth, endAnalysisYear, endAnalysisMonth)
...
# miHuronGroundwater_A = getSubset(miHuronGroundwater, startAnalysisYear, startAnalysisMonth, endAnalysisYear, endAnalysisMonth)
...
# clairGroundwater_A = getSubset(clairGroundwater, startAnalysisYear, startAnalysisMonth, endAnalysisYear, endAnalysisMonth)
...
# erieGroundwater_A = getSubset(erieGroundwater, startAnalysisYear, startAnalysisMonth, endAnalysisYear, endAnalysisMonth)
...
# ontarioGroundwater_A = getSubset(ontarioGroundwater, startAnalysisYear, startAnalysisMonth, endAnalysisYear, endAnalysisMonth)
...
clairEvap_Prior[is.na(clairEvap_Prior[,priorEvapColumn]),priorEvapColumn] = clairEvap_ResidPrior[is.na(clairEvap_Prior[,priorEvapColumn]),3]
...
superiorGroundwaterPriorMean = miHuronGroundwaterPriorMean = NULL #--JLC
superiorGroundwaterPriorPrecision = miHuronGroundwaterPriorPrecision = NULL #--JLC
...
clairGroundwaterPriorMean = NULL #--JLC
clairGroundwaterPriorPrecision = NULL #--JLC
...
erieGroundwaterPriorMean = NULL #--JLC
erieGroundwaterPriorPrecision = NULL #--JLC
...
ontarioOutflowPriorMean = NULL #--JLC
ontarioOutflowPriorPrecision = NULL #--JLC
ontarioGroundwaterPriorMean = NULL;
ontarioGroundwaterPriorPrecision = NULL;
...
for(i in 1:12){
	...
	## Groundwater --JLC
	superiorGroundwaterPriorMean[i] =  superiorGroundwater[i]
	superiorGroundwaterPriorPrecision[i] = 1/var(superiorGroundwater) #conflating inter-annual variability with intra-annual variability
  miHuronGroundwaterPriorMean[i] =  miHuronGroundwater[i]
	miHuronGroundwaterPriorPrecision[i] = 1/var(miHuronGroundwater) #conflating inter-annual variability with intra-annual variability
	...
	clairGroundwaterPriorMean[i] =  0
	clairGroundwaterPriorPrecision[i] = 0.01 #guess (10 cubic meters per second)
	...
	erieGroundwaterPriorMean[i] =  erieGroundwater[i]
	erieGroundwaterPriorPrecision[i] = 1/var(erieGroundwater) #conflating inter-annual variability with intra-annual variability
	...
	ontarioGroundwaterPriorMean[i] =  ontarioGroundwater[i]
	ontarioGroundwaterPriorPrecision[i] = 1/var(ontarioGroundwater) #conflating inter-annual variability with intra-annual variability
