model {
	for (j in posteriorStartMonth:posteriorEndMonth){   										
		...
		ySuperiorRunoff6[j] ~ dnorm(ySuperiorRunoff6Mean[j], ySuperiorRunoff6Prec)
		ySuperiorRunoff6Mean[j] <- superiorRunoff[j] + ySuperiorRunoff6Bias[m[j]]
		...
		yMiHuronRunoff6[j] ~ dnorm(yMiHuronRunoff6Mean[j], yMiHuronRunoff6Prec)
		yMiHuronRunoff6Mean[j] <- miHuronRunoff[j] + yMiHuronRunoff6Bias[m[j]]
		...
		yErieRunoff6[j] ~ dnorm(yErieRunoff6Mean[j], yErieRunoff6Prec)
		yErieRunoff6Mean[j] <- erieRunoff[j] + yErieRunoff6Bias[m[j]]
		...
		yOntarioRunoff6[j] ~ dnorm(yOntarioRunoff6Mean[j], yOntarioRunoff6Prec)
		yOntarioRunoff6Mean[j] <- ontarioRunoff[j] + yOntarioRunoff6Bias[m[j]]
	...
	for (i in 1:12){
		...
		ySuperiorRunoff6Bias[i] ~ dnorm(0,0.01)
		...
		yMiHuronRunoff6Bias[i] ~ dnorm(0,0.01)
		...
		yErieRunoff6Bias[i] ~ dnorm(0,0.01)
		...
		yOntarioRunoff6Bias[i] ~ dnorm(0,0.01)
	...
	ySuperiorPrecip1Prec ~ dlnorm(-log(100),1)
	ySuperiorPrecip2Prec ~ dlnorm(-log(100),1)
	ySuperiorPrecip3Prec ~ dlnorm(-log(100),1)
	ySuperiorPrecip4Prec ~ dlnorm(-log(100),1)
	ySuperiorPrecip5Prec ~ dlnorm(-log(100),1)
	ySuperiorPrecip6Prec ~ dlnorm(-log(100),1)
	yMiHuronPrecip1Prec ~ dlnorm(-log(100),1)
	yMiHuronPrecip2Prec ~ dlnorm(-log(100),1)
	yMiHuronPrecip3Prec ~ dlnorm(-log(100),1)
	yMiHuronPrecip4Prec ~ dlnorm(-log(100),1)
	yMiHuronPrecip5Prec ~ dlnorm(-log(100),1)
	yMiHuronPrecip6Prec ~ dlnorm(-log(100),1)
	yEriePrecip1Prec ~ dlnorm(-log(100),1)
	yEriePrecip2Prec ~ dlnorm(-log(100),1)
	yEriePrecip3Prec ~ dlnorm(-log(100),1)
	yEriePrecip4Prec ~ dlnorm(-log(100),1)
	yEriePrecip5Prec ~ dlnorm(-log(100),1)
	yEriePrecip6Prec ~ dlnorm(-log(100),1)
	yOntarioPrecip1Prec ~ dlnorm(-log(100),1)
	yOntarioPrecip2Prec ~ dlnorm(-log(100),1)
	yOntarioPrecip3Prec ~ dlnorm(-log(100),1)
	yOntarioPrecip4Prec ~ dlnorm(-log(100),1)
	yOntarioPrecip5Prec ~ dlnorm(-log(100),1)
	yOntarioPrecip6Prec ~ dlnorm(-log(100),1)
	ySuperiorEvap1Prec ~ dlnorm(-log(100),1)
	ySuperiorEvap2Prec ~ dlnorm(-log(100),1)
	ySuperiorEvap3Prec ~ dlnorm(-log(100),1)
	yMiHuronEvap1Prec ~ dlnorm(-log(100),1)
	yMiHuronEvap2Prec ~ dlnorm(-log(100),1)
	yMiHuronEvap3Prec ~ dlnorm(-log(100),1)
	yErieEvap1Prec ~ dlnorm(-log(100),1)
	yErieEvap2Prec ~ dlnorm(-log(100),1)
	yErieEvap3Prec ~ dlnorm(-log(100),1)
	yOntarioEvap1Prec ~ dlnorm(-log(100),1)
	yOntarioEvap2Prec ~ dlnorm(-log(100),1)
	yOntarioEvap3Prec ~ dlnorm(-log(100),1)
	ySuperiorRunoff1Prec ~ dlnorm(-log(100),1)
	ySuperiorRunoff2Prec ~ dlnorm(-log(100),1)
	ySuperiorRunoff3Prec ~ dlnorm(-log(100),1)
	ySuperiorRunoff4Prec ~ dlnorm(-log(100),1)
	ySuperiorRunoff5Prec ~ dlnorm(-log(100),1)
	ySuperiorRunoff6Prec ~ dlnorm(-log(100),1)
	yMiHuronRunoff1Prec ~ dlnorm(-log(100),1)
	yMiHuronRunoff2Prec ~ dlnorm(-log(100),1)
	yMiHuronRunoff3Prec ~ dlnorm(-log(100),1)
	yMiHuronRunoff4Prec ~ dlnorm(-log(100),1)
	yMiHuronRunoff5Prec ~ dlnorm(-log(100),1)
	yMiHuronRunoff6Prec ~ dlnorm(-log(100),1)
	yErieRunoff1Prec ~ dlnorm(-log(100),1)
	yErieRunoff2Prec ~ dlnorm(-log(100),1)
	yErieRunoff3Prec ~ dlnorm(-log(100),1)
	yErieRunoff4Prec ~ dlnorm(-log(100),1)
	yErieRunoff5Prec ~ dlnorm(-log(100),1)
	yErieRunoff6Prec ~ dlnorm(-log(100),1)
	yOntarioRunoff1Prec ~ dlnorm(-log(100),1)
	yOntarioRunoff2Prec ~ dlnorm(-log(100),1)
	yOntarioRunoff3Prec ~ dlnorm(-log(100),1)
	yOntarioRunoff4Prec ~ dlnorm(-log(100),1)
	yOntarioRunoff5Prec ~ dlnorm(-log(100),1)
	yOntarioRunoff6Prec ~ dlnorm(-log(100),1)
	yClairNBS1Prec ~ dlnorm(-log(100),1)
	...
	for(jp in posteriorStartMonth:posteriorEndMonth){		
		...
		ySuperiorRunoff6PP[jp] ~ dnorm(ySuperiorRunoff6Mean[jp], ySuperiorRunoff6Prec)
		...
		yMiHuronRunoff6PP[jp] ~ dnorm(yMiHuronRunoff6Mean[jp], yMiHuronRunoff6Prec)
		...
		yErieRunoff6PP[jp] ~ dnorm(yErieRunoff6Mean[jp], yErieRunoff6Prec)
		...
		yOntarioRunoff6PP[jp] ~ dnorm(yOntarioRunoff6Mean[jp], yOntarioRunoff6Prec)
