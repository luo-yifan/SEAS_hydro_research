...
superiorDStore025 = jSum[paste('ySuperiorDStorePP[',1:nMonths,']', sep=''),3];
superiorDStoreMedian = jSum[paste('ySuperiorDStorePP[',1:nMonths,']', sep=''),5];
superiorDStore975 = jSum[paste('ySuperiorDStorePP[',1:nMonths,']', sep=''),7];
superiorDStore = cbind(pTime, superiorDStoreMedian, superiorDStore025, superiorDStore975);
write.table(format(superiorDStore, digits=3), paste('superiorDStorePP_',modelName,'.csv',sep=''), append=FALSE, quote=FALSE, sep=',', row.names=FALSE, col.names=c('Year','Month','Median','2.5 Percentile', '97.5 Percentile'));
...
miHuronDStore025 = jSum[paste('yMiHuronDStorePP[',1:nMonths,']', sep=''),3];
miHuronDStoreMedian = jSum[paste('yMiHuronDStorePP[',1:nMonths,']', sep=''),5];
miHuronDStore975 = jSum[paste('yMiHuronDStorePP[',1:nMonths,']', sep=''),7];
miHuronDStore = cbind(pTime, miHuronDStoreMedian, miHuronDStore025, miHuronDStore975);
write.table(format(miHuronDStore, digits=3), paste('miHuronDStorePP_',modelName,'.csv',sep=''), append=FALSE, quote=FALSE, sep=',', row.names=FALSE, col.names=c('Year','Month','Median','2.5 Percentile', '97.5 Percentile'));
...
erieDStore025 = jSum[paste('yErieDStorePP[',1:nMonths,']', sep=''),3];
erieDStoreMedian = jSum[paste('yErieDStorePP[',1:nMonths,']', sep=''),5];
erieDStore975 = jSum[paste('yErieDStorePP[',1:nMonths,']', sep=''),7];
erieDStore = cbind(pTime, erieDStoreMedian, erieDStore025, erieDStore975);
write.table(format(erieDStore, digits=3), paste('erieDStorePP_',modelName,'.csv',sep=''), append=FALSE, quote=FALSE, sep=',', row.names=FALSE, col.names=c('Year','Month','Median','2.5 Percentile', '97.5 Percentile'));
...
ontarioDStore025 = jSum[paste('yOntarioDStorePP[',1:nMonths,']', sep=''),3];
ontarioDStoreMedian = jSum[paste('yOntarioDStorePP[',1:nMonths,']', sep=''),5];
ontarioDStore975 = jSum[paste('yOntarioDStorePP[',1:nMonths,']', sep=''),7];
ontarioDStore = cbind(pTime, ontarioDStoreMedian, ontarioDStore025, ontarioDStore975);
write.table(format(ontarioDStore, digits=3), paste('ontarioDStorePP_',modelName,'.csv',sep=''), append=FALSE, quote=FALSE, sep=',', row.names=FALSE, col.names=c('Year','Month','Median','2.5 Percentile', '97.5 Percentile'));
...
clairDStore025 = jSum[paste('yClairDStorePP[',1:nMonths,']', sep=''),3];
clairDStoreMedian = jSum[paste('yClairDStorePP[',1:nMonths,']', sep=''),5];
clairDStore975 = jSum[paste('yClairDStorePP[',1:nMonths,']', sep=''),7];
clairDStore = cbind(pTime, clairDStoreMedian, clairDStore025, clairDStore975);
write.table(format(clairDStore, digits=3), paste('clairDStorePP_',modelName,'.csv',sep=''), append=FALSE, quote=FALSE, sep=',', row.names=FALSE, col.names=c('Year','Month','Median','2.5 Percentile', '97.5 Percentile'));
