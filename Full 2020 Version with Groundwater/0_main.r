...
rootDir = "~/WorkSpace/L2SWBM_groundwater/Full 2020 Version with Groundwater"
setwd(rootDir);
...
source('../../../4_tsPlotter_Preview_JLC.r')
...
setwd(file.path(rootDir,"output", modelName))
source('../../6_proc_model_write_JLC.r');
