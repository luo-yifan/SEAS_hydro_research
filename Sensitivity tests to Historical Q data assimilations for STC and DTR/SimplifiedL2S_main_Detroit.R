...
outputname = 'Nov17_v9_SFD_Detroit_Q_200k_'
...
# OutflowShapeLkStCl      =NULL   # sk 11/17 comment for SFD
# OutflowMeanLkStCl       =NULL   # sk 11/17 comment for SFD
# OutflowPrecisionLkStCl  =NULL   # sk 11/17 comment for SFD
InflowShapeLkStCl       =NULL   # sk 11/17 comment for SFD
InflowMeanLkStCl        =NULL   # sk 11/17 comment for SFD
InflowPrecisionLkStCl   =NULL   # sk 11/17 comment for SFD
###### Erie ######
PrecipShapeEri          =NULL
PrecipRateEri           =NULL
...
for (i in 1:12){
  ...
  ## LAKE St. Clair ##
# sk  # OutflowDatLkStCl          =PriorLkStClOutData[as.numeric(format(as.Date(PriorLkStClOutData[,6]),"%m"))==i,Outflow.Column.Number]
# sk  # OutflowDatLkStCl          =as.numeric(do.call(c,OutflowDatLkStCl))
# sk  # OutflowMeanLkStCl[i]      =mean(OutflowDatLkStCl,na.rm = TRUE)
# sk  # OutflowPrecisionLkStCl[i] =(1/var(OutflowDatLkStCl,na.rm = TRUE))
  ## Erie ##
  ...
  ## Erie ##
# sk  # InflowDatEri         =PriorEriInflData[as.numeric(format(as.Date(PriorEriInflData[,6]),"%m"))==i,Inflow.Column.Number]
# sk  # InflowDatEri         =as.numeric(do.call(c,InflowDatEri))
# sk  # InflowMeanEri[i]     =mean(InflowDatEri,na.rm = TRUE)
# sk  # InflowPrecisionEri[i]=(1/var(InflowDatEri,na.rm = TRUE))
}
...
miHuronBOMPost = as.numeric(miHuronBOM[PosteriorRange,3])  #sk 10/14/21
...
erieBOMPost = as.numeric(erieBOM[PosteriorRange,3]) #sk 11/17
...
# sk  "OutflowMeanLkStCl"     =OutflowMeanLkStCl,
# sk  "OutflowPrecisionLkStCl"=OutflowPrecisionLkStCl,
...
jMod = jags.model(file = "SimplifiedL2S_jags_Detroit.jags.r", data = inputDataCoreJAGS, n.chains = 3) 
